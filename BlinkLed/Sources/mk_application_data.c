...
K_MK_SECTION_STACK uint32_t g_mkStack [ 1024 ];
...
K_MK_SECTION_DESCRIPTOR T_mkApplicationDynamicHeader g_mkApplicationDynamicHeader =
{
   ...
   /* Descripteur d'application */
   {
      ...
      K_MK_APPLICATION_TYPE_DAEMON,                            /* Application d'arrière plan */
      K_MK_TYPE_FLOATING_PRIVILEGED,                           /* Tâche flottante non privilégiée */
      ...
      1024,                                                    /* Taille de la stack. */
      main,                                                    /* Point d'entrée de l'application */
      ( T_mkAddr ) K_MK_NULL                                   /* Argument d'une application statique (non utilisé) */
   },
